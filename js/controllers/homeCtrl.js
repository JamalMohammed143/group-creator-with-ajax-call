ngApp.controller('homeCtrl', ['$scope', '$rootScope', '$timeout', '$http', '$location', '$state', '$window', function ($scope, $rootScope, $timeout, $http, $location, $state, $window) {
    ...
    $scope.getPrevGroupList = function () {
        $scope.unSelMembersList = [];
    ...
    $scope.prevListToggleNav = function () {
        $scope.memrsListViewOpenIs = !$scope.memrsListViewOpenIs;
    };
